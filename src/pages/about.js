  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <p>
            I did studied physics and some mathematics a while ago. 
        </p>
        <p>
            I liked it so much I did a PhD in Particle Physics, during which I did a lot of programming.
        </p>
        <p>
            I then realised how powerful programming was and got a role as a Software Engineer at a company doing some stuff in Oil and Gas.
        </p>
        <p>
        ...
        <p>
            Now I am a nuclear scientist / software engineer, where I get to do programing, physics, and research!
        </p>
      </Layout>
    )
  }
