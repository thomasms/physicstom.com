...
class Table extends React.Component {
  ...
  createElements(data, offset, base_colour="grey"){
   var elements = [];
  ...
  rowLeftElements(data){
    return (
      <>
      {this.createElements(data, 0, BORDER_COLOR)}
      </>
    );
  }
  ...
  rowRightElements(data){
    return (
      <>
      {this.createElements(data, MAX_LENGTH-data.length, BORDER_COLOR)}
      </>
    );
  }
  ...
  allElements(){
    return (
      ...
      {this.rowMiddleElements(this.createElementsInRange(57, 71), BORDER_COLOR)}
      {this.rowMiddleElements(this.createElementsInRange(89, 103),BORDER_COLOR)}
      </>
    );
  }
    ...
    */
    ...
    return (
      <div>
        ...
        <div className="apps-periodictable-table-details">
          <p className="apps-periodictable-table-details-title">
            {elementName}
          </p>
          <p>
            {info}
